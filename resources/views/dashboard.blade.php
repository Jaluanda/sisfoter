...
@section('content')
    ...
    <section class="section">
        ...
        <div class="row">
            <div class="container">
                <iframe class="responsive-iframe"  src="https://app.powerbi.com/view?r=eyJrIjoiNDE4NTZhYjQtMmZjNi00NzcwLTllYTQtNzM2ZmQyMjAzMThkIiwidCI6ImQ3Yjk1ZWM0LTlhN2YtNDI2MC1iMmUzLWViNTNmMGFjODQwMSIsImMiOjEwfQ%3D%3D" frameborder="0" allowFullScreen="true"></iframe>
            </div>
        </div>
