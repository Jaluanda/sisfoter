                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="GET" action="#">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">No Personel (NRP)</label>
                                    <div class="col-sm-12 col-md-7">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <a href="{{ route('sisfopers.list') }}" class="btn btn-outline-info"><i class="fas fa-backward"></i> Kembali ke Daftar</a>
