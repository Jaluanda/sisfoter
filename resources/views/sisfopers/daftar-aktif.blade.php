...
@section('title')
    Daftar Personel Siap Bertugas
@endsection

@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Daftar Personel Siap Bertugas</h1>
        </div>

        <div class="section-body">

            <h2 class="section-title">Siap Bertugas</h2>
            <p class="section-lead">Daftar personel berikut merupakan personel yang sedang tidak menjalankan tugas kedinasan ataupun operasi militer.</p>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive table-invoice">
                                <table class="table table-striped">
                                    ...
                                    @forelse($dataAktif as $key => $value)
                                        <tr>
                                            <td class="font-weight-600">{{ (($dataAktif->currentPage() * 10) - 10) + $loop->iteration }}</td>
                                            ...
                                            <td class="font-weight-600">
                                                    <span class="badge badge-success">Siap bertugas</span>
                                            </td>
                                            <td class="font-weight-600">
