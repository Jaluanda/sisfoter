...
{{--        <x-jet-welcome />--}}
        ...
        <script src="https://demo.getstisla.comassets/modules/popper.js"></script>
        <script src="https://demo.getstisla.comassets/modules/tooltip.js"></script>
        <script src="https://demo.getstisla.comassets/modules/bootstrap/js/bootstrap.min.js"></script>
        <script src="https://demo.getstisla.comassets/modules/nicescroll/jquery.nicescroll.min.js"></script>
        <script src="https://demo.getstisla.comassets/modules/moment.min.js"></script>
        <script src="https://demo.getstisla.comassets/js/stisla.js"></script>

        <!-- JS Libraies -->
        <script src="https://demo.getstisla.comassets/modules/simple-weather/jquery.simpleWeather.min.js"></script>
        <script src="https://demo.getstisla.comassets/modules/chart.min.js"></script>
        <script src="https://demo.getstisla.comassets/modules/jqvmap/dist/jquery.vmap.min.js"></script>
        <script src="https://demo.getstisla.comassets/modules/jqvmap/dist/maps/jquery.vmap.world.js"></script>
        <script src="https://demo.getstisla.comassets/modules/summernote/summernote-bs4.js"></script>
        <script src="https://demo.getstisla.comassets/modules/chocolat/dist/js/jquery.chocolat.min.js"></script>

        <!-- Page Specific JS File -->
        <script src="https://demo.getstisla.comassets/js/page/index-0.js"></script>

        <!-- Template JS File -->
        <script src="https://demo.getstisla.comassets/js/scripts.js"></script>
        <script src="https://demo.getstisla.comassets/js/custom.js"></script>
    </div>
</x-app-layout>
